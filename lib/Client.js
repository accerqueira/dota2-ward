...
var Invoker = require('method-invoker');
...
var Client = module.exports = function(clientToken, options) {
    ...
    this.setAPIPolicy(new Invoker().throttle(1/1000).getDecorator());
};
...
Client.prototype.setAPIPolicy = function(policy) {
    this.requester = policy(request);
};
...
Client.prototype.getUrl = function(url) {
    ...
    this.requester({'url': url, 'headers': headers}).then(function(req) {
